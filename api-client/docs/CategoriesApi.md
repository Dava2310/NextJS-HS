...
const { status, data } = await apiInstance.categoriesControllerCreate(
    createCategoryDto
);
```
...
const { status, data } = await apiInstance.categoriesControllerFindOne(
    id
);
```
...
const { status, data } = await apiInstance.categoriesControllerRemove(
    id
);
```
...
const { status, data } = await apiInstance.categoriesControllerUpdate(
    id,
    updateCategoryDto
);
```
